...
//FUNKCIJE
function ispisPadajuci(mestoIspisa, ispis, initValue = "Choose your destination") {
  var selekt = `<select class="form-control ">
                  <option>${initValue}</option>
  `;
...
var meni = ["Home", "Destination", "Packages", "Special Offres", "Blog", "Book Now"];
...
var gradoviNaziv = ["Istanbul", "Praga", "Paris", "Cyprus", "Santorini", "Barcelona"];
...
var hoteli = ["Enter your hotel", "Emirates Palace", "Mardan Palace", "Burj Al Arab", "Atlantis Paradise", "The Las Vegas Palms"];
...
var brojDana = ["Enter duration", 5, 7, 10, 15, 20];
...
var brojOsoba = ["Enter members", 1, 2, 3, 4, 5];
ispisPadajuci(members1, brojOsoba);
ispisPadajuci(members2, brojOsoba);

// ispis letovi
var klasa = ["Enter Class", "A", "B", "C"];
var odrasli = ["Enter Adults", 1, 2, 3, 4, 5, 6, 7, 8];
var deca = ["Enter childs", 1, 2, 3, 4, 5, 6, 7, 8];
...
function ispisSpecPonuda() {
  ...
  // console.log(ispisPonude);
  let tempIspis = ispisPonude.substr(9);
  console.log(tempIspis);
  specPonude.innerHTML = tempIspis;
}
...
var trajanjePonude = ["Dec 19 2021 00:00", "Dec 25 2021 00:00", "Jan 05 2022 00:00"];
						...
						<div class="col-sm-4">
							<div class="single-special-offer">
								...
								<div class="single-special-shape-txt">
									...
									<p><span>$ ${cenaSpo[i]}</span><br>reguler $${regCenaSpo[i]}</p>
...
ispisPadajuci(bookSelect, gradoviNaziv);
